...
List<Post> postData = [
  ...
  Post(
    title: 'Anger & Delay',
    datePosted: DateTime(2026, 1, 2),
    image: 'images/1.png',
    id: '211',
    body: 'The best remedy for anger is delay.\n\n'
        'After some time has passed, you can see the insignificance of what '
        'angered you.',
  ),
  Post(
    title: 'Back Yourself',
  ...
  Post(
    ...
    id: '207',
    body:
        '"The Person of honour thinks of their character, the inferior person '
        'of their position" - Confucius',
  ),
  Post(
    title: 'Onward',
    ...
    image: 'images/1.png',
    id: '206',
    body: 'Some spend so much time trying to recreate old experiences '
        'they miss out on new ones.\n\n'
        'We should keep fond memories to be just that, memories.\n\n'
        'This way we increase our chances of greater experiences.',
  ),
  Post(
    title: 'Adapt',
  ...
  Post(
    ...
    body: 'A complex system that works is invariably found to have evolved '
        ...
        'from scratch cannot be made to work.\n\n'
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '201',
    body: 'Reflection unlocks insights.\n\n'
        'Insights beget change.\n\n'
        'Take time to sit quietly and reflect on your actions.',
  ),
  Post(
    title: 'Courage',
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '198',
    body: 'Do not trap yourself within the limitations of others.',
  ),
  Post(
    title: 'Wanting',
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '195',
    body: 'The internet was once an escape from the real world.\n\n'
        'Now the real world is an escape from the internet.\n\n'
        'Unplug and experience reality with all your senses.',
  ),
  Post(
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '183',
    body: 'Good leaders share the credit when things go well and take '
        'responsibility when things go poorly.',
  ),
  Post(
  ...
  Post(
    title: 'Seek Wide Experiences',
    datePosted: DateTime(2025, 6, 6),
    image: 'images/1.png',
    id: '181',
    body: 'Inspiration can be found in unlikely places.\n\n'
        'Do things you would not normally do.\n\n'
        'Engage with people unlike you.\n\n'
        'Try new things.\n\n'
        'Seek wide experiences.',
  ),
  Post(
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '179',
    body: 'It is not difficult to find videos of people in the gym completing '
        'exercises that may look wildly incorrect.\n\n'
        'Some may laugh at these people.\n\n'
        'Trainers are taught to correct their form if they deem it incorrect.\n\n'
        'The truth is there are many ways to train, and exercises you see '
        'others do may not make sense to you, but they may be very specific to '
        'the person\'s goals.\n\n'
        'If you see something that looks wrong to you, do not jump to '
        'judgement.\n\n'
        'Ask why.\n\n'
  ...
  Post(
    ...
    body: 'To maximise happiness, we must do things we do not want to do.\n\n'
        ...
        'This can not only lead to a sense of pride in what we have achieved, '
  ...
  Post(
    ...
    body: 'Plant trees under which you do not expect to sit.\n\n'
        'Invest in assets which you do not personally expect to benefit from.\n\n'
